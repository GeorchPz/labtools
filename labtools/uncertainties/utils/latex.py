...
def latex_escape_special_characters(text, structure=True, greek=True, math=True):
    ...
    """
    # Create copies of the global dictionaries based on parameters
    struct_chars = STRUCTURE_CHARACTERS.copy() if structure else {}
    greek_chars = GREEK_CHARACTERS.copy() if greek else {}
    math_chars = MATH_CHARACTERS.copy() if math else {}
