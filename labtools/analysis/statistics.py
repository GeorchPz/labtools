import numpy as np
from ..uncertainties import isiterable, rounder
...
def calculate_statistics(variables, x, δx, x_exp = None):
    '''
    ...
    Parameters:
        - variables : str or list, Variable(s) or symbol(s) of the variable(s) to compare
    ...
    Returns:
        - dict :
            - Variable : str or list, variables
