...
def curve_format_formula(parameters, errors, variables, equation):
    '''
    ...
    for variable, value, uncert in zip(variables, parameters, errors):
        formula = formula.replace(variable, f'({round_with_uncertainty(value, uncert)})')
