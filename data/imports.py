...
def load_excel(filename, sheet_name=0, directory=None):
    '''
...
def load_csv(filename, delimiter=',', directory=None):
    
    file_path = get_file_path(filename, extension='.txt', directory=directory)
